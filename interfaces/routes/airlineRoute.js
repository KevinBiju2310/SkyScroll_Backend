...
router.post("/aircrafts/:id/seats", verifyTokenAirline, aircraftController.addSeats);
...
router.patch("/bookings/:id/status", verifyTokenAirline, airlineController.changeBookingStatus);
